...
export const metadata: Metadata = {
  title: 'Aviso Legal y Condiciones de Uso - AdivinaExamen',
  description: 'Consulta el aviso legal y las condiciones generales de uso del sitio web y la aplicación AdivinaExamen.',
};
    ...
    <Card className="w-full shadow-lg">
      ...
      <CardContent className="space-y-6 text-foreground/90 prose prose-sm sm:prose-base max-w-none">
        <section aria-labelledby="datos-identificativos">
          ...
          <p>En cumplimiento del deber de información establecido en la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y de Comercio Electrónico (LSSI-CE), a continuación se facilitan los datos generales del titular del sitio web y de la aplicación "AdivinaExamen":</p>
        ...
        <section aria-labelledby="objeto-ambito">
          ...
          <p>El presente Aviso Legal y las Condiciones Generales de Uso (en adelante, "Condiciones") regulan el acceso y la utilización del sitio web y de la aplicación "AdivinaExamen" (en adelante, "la Plataforma"), propiedad de SEARCH AND MAKE S.L.</p>
